          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                  icon: FaIcon(FontAwesomeIcons.linkedin), // Change to LinkedIn icon
                ...
                IconButton(
                  icon: FaIcon(FontAwesomeIcons.instagram), // Change to Instagram icon
                  color: Colors.purple,
                  onPressed: () {
                ...
                IconButton(
                  icon: FaIcon(FontAwesomeIcons.youtube), // Change to YouTube icon
                  color: Colors.red,
                  onPressed: () {
